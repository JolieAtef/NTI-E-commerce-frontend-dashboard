...
export const routes: Routes = [
  ...
  { path: 'home', title: 'Home', canActivate: [authGuard], loadComponent: () => import('./home/home.component').then(m => m.HomeComponent) },
  {
    ...
    children: [
      ...
      { path: ':id', title: 'update Category', loadComponent: () => import('./update-categories/update-categories.component').then(m => m.UpdateCategoriesComponent) }
    ]
  },
  {
    ...
    children: [
     ...
     { path: ':id', title: 'update Subcategories', loadComponent: () => import('./update-subcategories/update-subcategories.component').then(m => m.UpdateSubcategoriesComponent) }
    ]
  },
